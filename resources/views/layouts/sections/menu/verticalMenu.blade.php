<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header fw-medium mt-3"><span class="menu-header-text">Dashboard</span></li>
        <!-- Dashboard -->
        <li class="menu-item">
        ...
        <li class="menu-header fw-medium mt-3"><span class="menu-header-text">Masters</span></li>
        <!-- Masters -->
        <li class="menu-item">
    ...
    <li class="menu-header fw-medium mt-3"><span class="menu-header-text">Activity</span></li>
    <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
    ...
    <li class="menu-header fw-medium mt-3"><span class="menu-header-text">User Management</span></li>
    <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
