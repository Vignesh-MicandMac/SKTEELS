...
@section('content')
<h5 class="py-3 mb-4"><span class="text-muted fw-light">Masters/</span> Add New Dealer</h5>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('masters.dealers.store') }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="area" class="form-control" placeholder="Enter your Area" value="{{ old('area') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="gst_no" class="form-control" placeholder="Enter your GST Number (Optional)" value="{{ old('gst_no') }}">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-12 d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm">Add Dealer</button>
                        </div>
                    </div>
                </form>
