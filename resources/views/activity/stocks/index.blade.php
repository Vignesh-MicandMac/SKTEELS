...
@section('content')
<h5 class="py-3 mb-4"><span class="text-muted fw-light">Masters/</span> Add Stock</h5>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">Bulk Upload Stocks</h5>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                <div class="d-flex justify-content-between mb-3">
                    <a href="{{ asset('storage/uploads/samples/stocks_sample.xlsx') }}"
                ...
                <form method="POST" action="{{ route('activity.stocks.bulkUpload' )}}" enctype="multipart/form-data">
                    @csrf
...
<div class="row">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('activity.stocks.store') }}">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="dispatch" class="form-control" value="{{old('dispatch')}}">
                        <small class="text-muted d-block fw-bold"><span class="text-danger">*</span>Please enter only numeric values.</small>
                        @error('dispatch') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
