...
@section('content')
<h5 class="py-3 mb-4"><span class="text-muted fw-light">Masters/</span> Update Stock</h5>
...
<div class="row">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('activity.stocks.update') }}">
                @csrf
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-12 d-flex justify-content-end gap-2">
                        <a href="{{ route('activity.stocks.edit') }}" class="btn btn-secondary btn-sm">Cancel</a>
